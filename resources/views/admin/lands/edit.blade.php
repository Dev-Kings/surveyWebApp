                  ...
                  <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                      <form method="POST" action="{{ route('admin.lands.update', $land->id) }}">
                        ...
                        <div class="sm:col-span-6 p-2">
                          ...
                          <div class="mt-1">
                            <input type="text" id="land_price" name="land_price" 
                            class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" 
                        ...
                        <div class="sm:col-span-6 p-2">
                          ...
                          <div class="mt-1">
                            <input type="textarea" id="land_description" name="land_description" 
                            class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" 
                            value="{{ $land->land_description }}"/>
                          </div>
